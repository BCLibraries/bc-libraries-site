(window.webpackJsonp = window.webpackJsonp || []).push([[0], {
    105: function (e, a, t) {
        ...
        t.r(a);
        t(53);
        var r = t(0), n = t.n(r), l = t(49), c = t.n(l), i = t(2);
        var s = function (e) {
        ...
        var o = {
            ONL: {weight: -1, Stacks: -3, "1st Floor Microfilm": 1},
            TML: {weight: 0},
            BAPST: {weight: 0},
            BURNS: {weight: 0},
            ERC: {weight: 0},
        ...
        function m(e, a) {
            var t = o[e];
            return t[a] ? t[a] + t.weight : t.weight
        }

        function u(e, a) {
            return m(e.library, e.loc_display) - m(a.library, a.loc_display)
        }
        ...
        var h = function (e) {
            ...
            }(a)), n.a.createElement("div", {className: "catalog-result-item__publisher"}, a.publisher, " ", a.date), n.a.createElement("div", {className: "catalog-result-item__type"}, a.type), a.getit && function (e) {
                return n.a.createElement("div", {className: "catalog-result-item__getit"}, n.a.createElement("a", {href: e.link}, "Find online"))
            }(a), n.a.createElement(d, {item: a}), n.a.createElement("a", {
                href: a.link,
                "aria-hidden": "true",
                className: "media-body__mobile-link"
            }, "\xa0")), a.covers.length > 1 && function (e) {
                return n.a.createElement("div", {className: "media-right"}, n.a.createElement("a", {
                    href: e.link,
                    "aria-hidden": "true"
                }, n.a.createElement("img", {src: e.covers[0], alt: "", className: "cover-image"})))
            }(a))
        }, v = t(8), f = t.n(v), g = t(20);
        var b = function (e, a) {
            var t = Object(r.useState)({error: !1, items: [], total_results: 0}), n = Object(i.a)(t, 2), l = n[0],
                c = n[1], s = Object(r.useState)(!1), o = Object(i.a)(s, 2), m = o[0], u = o[1];

            function d() {
                return (d = Object(g.a)(f.a.mark(function a(t) {
                    var r, n;
                    return f.a.wrap(function (a) {
                        for (; ;) switch (a.prev = a.next) {
                            ...
                            case 3:
                                return u(!0), a.prev = 4, a.next = 7, fetch(t);
                            case 7:
                                return n = a.sent, a.next = 10, n.json();
                            case 10:
                                r = a.sent, a.next = 16;
                                break;
                            case 13:
                                a.prev = 13, a.t0 = a.catch(4), r = {error: !0, items: []};
                            case 16:
                                c(r), u(!1);
                            case 18:
                            case"end":
        ...
        var _ = function (e) {
            ...
            return o = o || "There are no results matching your search.", a = m.loading ? n.a.createElement("div", {className: "bento-results-box__loading-notice"}, "Loading") : u.error ? n.a.createElement("div", {className: "bento-results-box__error-notice"}, "There was an error performing this search.") : u.total_results ? n.a.createElement("div", {className: "".concat(s, "-results-box")}, n.a.createElement("ol", {className: "".concat(s, "-results-list")}, t(u)), n.a.createElement(E, {
                url: u.search_url,
                total: u.total_results,
                found: u.items.length,
                term: l
            })) : n.a.createElement("div", {className: "bento-results-box__no-results-notice"}, o), n.a.createElement("div", {className: "bento-results-box"}, n.a.createElement("div", {className: "bento-results-box__header-row"}, n.a.createElement("h3", {className: "bento-results-box__header"}, n.a.createElement("a", {href: u.search_url}, r)), n.a.createElement(E, {
                url: u.search_url,
                total: u.total_results,
                found: u.items.length,
                term: l
            ...
            return n.a.createElement(n.a.Fragment, null, e.items.map(function (e) {
                return n.a.createElement(h, {key: e.id, item: e})
            }))
        };
        var N = function (e) {
            var a = e.searchString;
            return n.a.createElement(_, {
                baseUrl: "http://libdev.bc.edu/search-services/catalog",
                classPrefix: "catalog",
                term: "results",
                heading: "Books & more",
                searchString: a,
        ...
        var k = function (e) {
            ...
            }, a.title)), a.date, n.a.createElement("div", {className: "article-result-item__creator"}, a.creator), n.a.createElement("div", {className: "article-result-item__publisher"}, function (e, a) {
                var t = e.split(a);
                return a && 2 === t.length ? n.a.createElement("span", {className: "article-result-item__journal-title"}, t[0], n.a.createElement("cite", null, a), t[1]) : n.a.createElement("span", null, e)
            }(a.part_of, a.journal)), n.a.createElement("a", {
                href: a.link,
                "aria-hidden": "true",
                className: "media-body__mobile-link"
            }, "\xa0")))
        ...
        var S = function (e) {
            var a = e.searchString;
            return n.a.createElement(_, {
                baseUrl: "http://libdev.bc.edu/search-services/articles",
                classPrefix: "article",
                term: "articles",
                heading: "Articles",
                searchString: a,
        ...
        var y = function (e) {
            ...
            var a = e.items.slice(0, 3);
            return n.a.createElement(n.a.Fragment, null, a.map(function (e) {
                return n.a.createElement(y, {key: e.id, result: e})
            }))
        };
        var j = function (e) {
            var a = e.searchString;
            return n.a.createElement(_, {
                baseUrl: "http://libdev.bc.edu/search-services/faq",
                classPrefix: "faq",
                term: "questions",
        ...
        var O = function (e) {
                var a = e.librarian, t = "http://libguides.bc.edu/prf.php?account_id=".concat(a.id),
                    r = "//".concat(a.image), l = "picture of ".concat(a.name), c = a.subjects.sort().join(", ");
                return n.a.createElement("li", {className: "media"}, n.a.createElement("div", {className: "media-left"}, n.a.createElement("a", {href: t}, n.a.createElement("img", {
                    src: r,
                    alt: l
                }))), n.a.createElement("div", {className: "media-body"}, n.a.createElement("h4", {className: "media-heading"}, n.a.createElement("a", {href: t}, a.name)), n.a.createElement("p", {className: "guide-description"}, c)))
            },
            R = n.a.createElement("div", {className: "no-results-found"}, n.a.createElement("a", {href: "http://libguides.bc.edu/ask-a-librarian/contact"}, "See all subject librarians"), "."),
            F = function (e) {
                return n.a.createElement(n.a.Fragment, null, e.items.map(function (e) {
                    return n.a.createElement(O, {key: e.id, librarian: e})
                }))
            };
        var L = function (e) {
            var a = e.searchString;
            return n.a.createElement(_, {
                baseUrl: "http://libdev.bc.edu/search-services/librarians",
        ...
        var I = function (e) {
            ...
            return n.a.createElement("li", {className: "physical-video col-md-4"}, n.a.createElement("a", {
                ...
                return e.creator ? e.creator : e.contributors[0] ? e.contributors[0] : ""
            }(a)), a.format, n.a.createElement(d, {item: a}))
        }, M = function (e) {
            return n.a.createElement(n.a.Fragment, null, e.items.map(function (e) {
                return function (e) {
                    var a = e.id;
        ...
        var D = function (e) {
            var a = e.searchString;
            return n.a.createElement(_, {
                baseUrl: "http://libdev.bc.edu/search-services/video",
                classPrefix: "video",
                term: "videos",
                heading: "Video",
                searchString: a,
        ...
        var $ = function (e) {
            ...
            return n.a.createElement("div", null, n.a.createElement("div", {className: "row"}, n.a.createElement("nav", {className: "link-to-results col-md-8"}, n.a.createElement("div", {className: "link-to-results__skip-to"}, "Skip to:"), n.a.createElement(s, {
                target: t,
                label: "Books & more"
            }), n.a.createElement(s, {target: l, label: "Articles"}), n.a.createElement(s, {
                target: c,
                label: "FAQ"
            }), n.a.createElement(s, {target: i, label: "Librarians"}), n.a.createElement(s, {
                target: o,
                label: "Video"
            }), n.a.createElement(s, {
                target: m,
                ...
                ref: t
            }, n.a.createElement(N, {searchString: a})), n.a.createElement("div", {
                className: "col-md-5 col-md-offset-1 col-sm-12",
                ref: l
            }, n.a.createElement(S, {searchString: a}))), n.a.createElement("div", {
                className: "results-row-2 row",
                ref: c
            }, n.a.createElement("div", {className: "col-md-7"}, n.a.createElement(j, {searchString: a})), n.a.createElement("div", {
                className: "col-md-4 col-md-offset-1",
                ref: i
            }, n.a.createElement(L, {searchString: a}))), n.a.createElement("div", {
        ...
        function ae(e, a) {
            a.suggestion;
            var t = a.suggestionValue,
                r = (a.suggestionIndex, a.sectionIndex, a.method, window.location.protocol + "//" + window.location.host + window.location.pathname);
            window.location.href = "".concat(r, "?any=").concat(t)
        }

        var te = function (e) {
            return n.a.createElement("div", {className: "search-suggestion"}, e.value)
        };
        var re = function (e) {
            var a = e.handleTyping, t = e.searchString, l = e.onSubmit, c = Object(r.useState)([]),
                s = Object(i.a)(c, 2), o = s[0], m = s[1], u = Object(r.useState)(t), d = Object(i.a)(u, 2), h = d[0],
                v = d[1];

            function b() {
                return (b = Object(g.a)(f.a.mark(function e(a) {
                    var t, r, n, l, c;
                    return f.a.wrap(function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
                                if (t = a.value, r = a.reason, n = "http://libdev.bc.edu/search-services/typeahead?any=".concat(t), l = [], !(t.length < Z)) {
                                    e.next = 5;
                                    break
                                }
                            ...
                            case 5:
                                ...
                                return e.abrupt("return");
                            case 7:
                                return e.prev = 7, e.next = 10, fetch(n);
                            case 10:
            ...
            return n.a.createElement("form", {
                method: "get",
                action: ".",
                className: "bento-search-box"
            }, n.a.createElement("label", {
                for: "bento-search-box__search-input",
                className: "bcbento-search-box__input-label sr-only"
            }, "Search"), n.a.createElement(Y.a, {
                suggestions: o,
                ...
                getSuggestionValue: ee,
                renderSuggestion: te,
                onSuggestionSelected: ae,
                inputProps: E,
        ...
        function ne(e) {
            return e ? "Search - ".concat(e) : "Search"
        }
        ...
        var le = function () {
            ...
            document.title = ne(e);
            var a = Object(r.useState)(e), t = Object(i.a)(a, 2), l = t[0], c = t[1], s = Object(r.useState)(""),
                o = Object(i.a)(s, 2), m = o[0], u = o[1], d = n.a.createElement(re, {
                    searchString: l, handleTyping: function (e) {
                        return u(e)
